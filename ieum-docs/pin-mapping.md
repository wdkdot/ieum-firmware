...
| `EINK_BUSY` | E-ink BUSY            |      30 | `P0.02`  |            2 | 입력, SSD1685 BUSY active high                                  |
| `EINK_RST`  | E-ink reset           |      31 | `P0.28`  |           28 | active low                                                      |
| `EINK_DC`   | E-ink data/command    |      32 | `P0.29`  |           29 | 출력                                                            |
| `SPI_MOSI`  | E-ink SPI MOSI        |      33 | `P0.30`  |           30 | `PIN_EINK_MOSI` 후보                                            |
| `EINK_CS`   | E-ink SPI chip select |      34 | `P0.26`  |           26 | active low                                                      |
...
- GDEY0266T90H 공식 사양에서 BUSY active high, RESET과 CS active low를 확인했다. PCB 신호의 직접 연결과 off-state pull/역급전은 실물로 확인한다.
